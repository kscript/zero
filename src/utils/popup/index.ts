import { nextTick, defineComponent, onUnmounted, onBeforeUnmount, onBeforeMount, reactive, watch, getCurrentInstance, ComponentInternalInstance, provide, toRefs } from 'vue'
// @ts-ignore
...
export default (props: anyObject) => {
